...
MainWindow::MainWindow(QWidget *pParent)
    ...
    const QString sUserAppsFolder(QStandardPaths::standardLocations(
    ...
    m_pTable->setHorizontalHeaderLabels(QStringList() << "Program" << "Exe Filepath");
...
void MainWindow::getShellLinks(const QString &sFolder,
    ...
    QDirIterator it(sFolder, {"*.lnk"}, QDir::NoFilter, QDirIterator::Subdirectories);
    while (it.hasNext()) {
